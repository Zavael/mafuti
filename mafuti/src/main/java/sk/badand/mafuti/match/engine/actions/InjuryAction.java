 ...
 * @author abadinka
 */
public class InjuryAction extends AbstractAction {

    private static final Logger LOG = Logger.getLogger(InjuryAction.class.getName());

    public InjuryAction(int actionTime, MatchEngineProvider mep) {
