 ...
 * @author abadinka
 */
public class LongPassAction extends AbstractAction {

    private static final Logger LOG = Logger.getLogger(LongPassAction.class.getName());

    public LongPassAction(int actionTime, MatchEngineProvider mep) {
