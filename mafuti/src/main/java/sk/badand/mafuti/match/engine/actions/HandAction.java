...
public class HandAction extends AbstractAction {
    ...
    private static final Logger LOG = Logger.getLogger(HandAction.class.getName());

    public HandAction(int actionTime, MatchEngineProvider mep) {
