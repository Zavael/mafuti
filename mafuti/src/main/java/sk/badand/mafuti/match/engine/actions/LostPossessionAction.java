...
public class LostPossessionAction extends AbstractAction {

    private static final Logger LOG = Logger.getLogger(LostPossessionAction.class.getName());

    public LostPossessionAction(int actionTime, MatchEngineProvider mep) {
    ...
    public ActionType getActionType() {
        return ActionType.LostPossession;
    }
