 ...
 * @author abadinka
 */
public class FoulAction extends AbstractAction {

    private static final Logger LOG = Logger.getLogger(FoulAction.class.getName());

    public FoulAction(int actionTime, MatchEngineProvider mep) {
