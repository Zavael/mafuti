 ...
 * @author abadinka
 */
public class DribbleAction extends AbstractAction {

    private static final Logger LOG = Logger.getLogger(DribbleAction.class.getName());

    public DribbleAction(int actionTime, MatchEngineProvider mep) {
