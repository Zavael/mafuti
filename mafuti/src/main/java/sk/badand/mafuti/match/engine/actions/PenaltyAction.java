 ...
 * @author abadinka
 */
public class PenaltyAction extends AbstractAction {

    private static final Logger LOG = Logger.getLogger(PenaltyAction.class.getName());

    public PenaltyAction(int actionTime, MatchEngineProvider mep) {
