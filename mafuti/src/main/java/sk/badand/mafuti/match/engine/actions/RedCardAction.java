 ...
 * @author abadinka
 */
public class RedCardAction extends AbstractAction {

    private static final Logger LOG = Logger.getLogger(RedCardAction.class.getName());

    public RedCardAction(int actionTime, MatchEngineProvider mep) {
