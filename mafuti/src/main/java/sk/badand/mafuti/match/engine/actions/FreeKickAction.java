 ...
 * @author abadinka
 */
public class FreeKickAction extends AbstractAction {

    private static final Logger LOG = Logger.getLogger(FreeKickAction.class.getName());

    public FreeKickAction(int actionTime, MatchEngineProvider mep) {
