 ...
 * @author abadinka
 */
public class CornerAction extends AbstractAction {

    private static final Logger LOG = Logger.getLogger(CornerAction.class.getName());

    public CornerAction(int actionTime, MatchEngineProvider mep) {
