 ...
 * @author abadinka
 */
public class ShortPassAction extends AbstractAction {

    private static final Logger LOG = Logger.getLogger(ShortPassAction.class.getName());

    public ShortPassAction(int actionTime, MatchEngineProvider mep) {
