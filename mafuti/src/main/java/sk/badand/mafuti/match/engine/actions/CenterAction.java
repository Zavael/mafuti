...
public class CenterAction extends AbstractAction {
    ...
    private static final Logger LOG = Logger.getLogger(CenterAction.class.getName());

    public CenterAction(int actionTime, MatchEngineProvider mep) {
    ...
    public void executeState(Machine machine) {
        ...
        mep.change();
        mep.notifyObservers("arg object");
