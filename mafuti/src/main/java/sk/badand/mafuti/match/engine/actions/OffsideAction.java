 ...
 * @author abadinka
 */
public class OffsideAction extends AbstractAction {

    private static final Logger LOG = Logger.getLogger(OffsideAction.class.getName());

    public OffsideAction(int actionTime, MatchEngineProvider mep) {
