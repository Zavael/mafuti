 ...
 * @author abadinka
 */
public class TackleAction extends AbstractAction {
    private static final Logger LOG = Logger.getLogger(TackleAction.class.getName());

    public TackleAction(int actionTime, MatchEngineProvider mep) {
