 ...
 * @author abadinka
 */
public class SlidingTackleAction extends AbstractAction {

    private static final Logger LOG = Logger.getLogger(SlidingTackleAction.class.getName());

    public SlidingTackleAction(int actionTime, MatchEngineProvider mep) {
    ...
    public ActionType getActionType() {
        return ActionType.SlidingTackle;
    }
