 ...
 * @author abadinka
 */
public class ShotSavedAction extends AbstractAction {

    private static final Logger LOG = Logger.getLogger(ShotSavedAction.class.getName());

    public ShotSavedAction(int actionTime, MatchEngineProvider mep) {
