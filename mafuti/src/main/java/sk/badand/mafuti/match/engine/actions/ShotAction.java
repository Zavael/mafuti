 ...
 * @author abadinka
 */
public class ShotAction extends AbstractAction {
    private static final Logger LOG = Logger.getLogger(ShotAction.class.getName());

    public ShotAction(int actionTime, MatchEngineProvider mep) {
