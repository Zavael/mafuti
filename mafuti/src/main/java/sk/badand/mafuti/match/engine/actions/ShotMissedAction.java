 ...
 * @author abadinka
 */
public class ShotMissedAction extends AbstractAction {

    private static final Logger LOG = Logger.getLogger(ShotMissedAction.class.getName());

    public ShotMissedAction(int actionTime, MatchEngineProvider mep) {
